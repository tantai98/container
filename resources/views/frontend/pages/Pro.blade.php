				...
				<div class="row t-margin">
					<div class="col-md-4  col-sm-12 col-xs-12 sm-margin-bottom-three t-padding-pro">
						<div class="row">
							<div class="col-md-12 ">
							<div class="">
								<img src="{{ $product_detail->img }}" alt="" class="product-imgs"/>
								...
								<p class="t-ten-sp" style="font-size: 11pt; margin-top: 23px !important; margin-bottom: 15px !important;">{{ $product_detail->name }}</p>
									<p><span>Mã : {!! $product_detail->code_product !!}</span></p>
								Giá : <span class="t-pro-gia"><span>
								@if($product_detail->price_sale)
									{!! number_format((int)$product_detail->price,0,'','.') !!} đ
								</span>{!! number_format((int)$product_detail->price_sale,0,'','.') !!} đ</span>
								@else
									{!! number_format((int)$product_detail->price,0,'','.') !!} đ
								@endif
								<!--Hệ thống 2 nút-->
									...
									<div class="col-md-12 col-sm-9 d-pd-button">
										<div class="row product-div t-dm-share-button">
											...
											<div class="col-md-9  col-sm-4 col-xs-8 ">
												<a class="highlight-button-dark btn-small no-margin-right no-margin-bottom t-ind-btn d-add-cart" data-id="{{ $product_detail->id }}">Thêm vào giỏ</a>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="t-splq">
									...
									@if($item->id != $product_detail->id)
										<div class="col-md-6 col-xs-6 no-padding ">
											...
											<p style="font-size: 9pt">{!! $item->name !!}</p>
											<span>
												@if($item->price_sale)
