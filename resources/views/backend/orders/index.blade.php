...
<div class="navbar">
    <div style="float:left;" class="title_form">
          ...
          <p>Tất cả đơn hàng {{isset($id) ? check_status_order($id) :''}}</p>
      ...
      <div class="box">
        ...
        <div class="box-body">
          ...
          <div class="dropdown-menu pull-right">
                 ...
                 <a  class="dropdown-item" href="{{route('order.type', ['id'=>3])}}">Đang giao hàng</a>
                 <a  class="dropdown-item" href="{{route('order.type', ['id'=>4])}}">Đã thanh toán</a>
                 <a  class="dropdown-item" href="{{route('order.type', ['id'=>5])}}">Đã nhận hàng</a>
          </div>
          <button class="number-post">{{$list_orders->count()}} ĐH</button>
          ...
          <table class="table m-b-none" ui-jp="footable" data-filter="#filter" data-page-size="10">
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td class="status change-status" data-id="{{$value->id}}">{{check_status_order($value->status)}}</td>
                  @if(session('admin')->can('xem_don_hang') || session('admin')->can('them_don_hang'))
