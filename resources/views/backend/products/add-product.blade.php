				    ...
				    <div class="col-sm-6 item">
				        <div class="box">
				          ...
				          <div class="box-body">
				          	...
				          	<p style="margin-top:0px;margin-bottom:10px; font-size:10pt; color:#a6a6a6" class="text-muted">Khi tạo một thuộc tính nhấn "Tab" hoặc "Enter" để kết thúc thuộc tính.</p>
				          	@if($attr_frame)
							...
							<div class="row">
									...
									<div class="col-md-12"  id="atrribute-containner">
										@if($attr_frame)
										<div class="row attr-item ">
								        	...
								        	<div class="col-sm-9 d-class" style="padding-left: 12px;padding-right: 13px;">
								        		<div class="form-group attr-item ">
										            <input type="text" placeholder="Thêm Màu Sắc" class="form-control " name="attrbute_frame" required>
										        </div>
								        	</div>
								        </div>
								        @endif
							...
							<div class="row">
								<div class="col-sm-12">
								            ...
								            <div class="form-group">
								              ...
								              <input type="text" class="form-control" name="product_code" autocomplete="off" >
								            </div>
								            <div class="form-group">
								            ...
								            <div class="form-group">
												...
												<input id="list_tag" class="stag-create" name="seo_tags">
											</div>
										 	<!-- 								    
											    <div class="form-group">
