                              ...
                              @endif
                                <tr>
                                  ...
                                  <label class="ui-check m-a-0">
                                    <input type="checkbox" @if(!session('admin')->can('sua_thuoc_tinh')) disabled @endif checked="" class="has-value filter_group price" >
                                  ...
                                  <td data-type="1">
                                    ...
                                    ?>
                                     ...
                                     ?>
                                      ...
                                      <div class="itemfilter itemfilter_type_1" data-filter="{{$value2->id}}"><span class="">{{$value2->min}} - {{$value2->max}}</span>
                                ...
                                <tr>
                                  <td style="width: 4%">
                                  <label class="ui-check m-a-0">
                                    <input type="checkbox" @if($value->status ==1 ) checked  @endif name="post[]" class="has-value filter_group" value="{{$value->id}}" @if(!session('admin')->can('sua_thuoc_tinh')) disabled @endif >
                                    <i class="dark-white" ></i>
                                  </label>
                                  </td>
                                  <td data-type="{{$value->avaiable}}" data-name="{{$value->name}}">
                                    ...
                                    @if($value->avaiable == 1)
                                      ...
                                      <!--  Danh sách item filter type 1 -->
                                      @foreach($list_filter_1 as $key2 => $value2)
                                      <div class="itemfilter itemfilter_type_1" data-filter="{{$value2->id}}"><span class="change-item">
                                      @if(strlen($value2->config_name) == 0)
                                    ...
                                    @else
                                      ...
                                      <div class="itemfilter itemfilter_type_0" data-filter="{{$value2->id}}"><span class="change-item">
                                      @if(strlen($value2->config_name) == 0)
                                      {{$value2->value}}
                                      @else
                                      {{$value2->config_name}}
                                  ...
                                  <td style="width: 4%">
                                    <label class="ui-check m-a-0 del_attribute" data-name="{{$value->name}}" style="padding-left:5px; font-family:Roboto Bold; font-size:12pt;">
                                      @if(session('admin')->can('xoa_thuoc_tinh'))  ×   @endif
                                    </label>
                                  </td>
                                </tr>
                                @endforeach
            ...
            success:function(data){
              if(data.status === true){
                ...
                if(data.item.img.length > 0) {
                  $("#model-preview").attr('src',"{{asset('')}}" + data.item.img);
                }else{
