            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td class="action-post d-1" style="padding-right:0px;">
                    <i style="color:#738CEC;" class="material-icons md-24 frame-popup " data-id="{{$value->id}}" data-link="{!! route('frame.create.frame',['id'=>$value->id]) !!}"></i>
                  </td>
                  <td>
