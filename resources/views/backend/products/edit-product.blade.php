												...
												<div class="row attr-item ">
										        	...
										        	<div class="col-sm-9 d-class" style="padding-left: 12px;padding-right: 13px;">
										        		<div class="form-group attr-item ">
												            <input type="text" placeholder="Thêm Màu Sắc" class="form-control " name="attrbute_frame" required value="{!! $frame_attr->value !!}">
												        </div>
										        	</div>
										        </div>
									        @endif
							...
							<div class="row">
									<div class="col-sm-12" style="">
									        ...
									        <select id="single" class="form-control select2" name="label">
									            ...
									            <option value="3" @if($product->label == 3 ) selected @endif>Sale</option>
									        </select>
									    </div>	
									</div>
				         	</div>	 
