               ...
               <div class="form-group">
                     ...
                     <label class="col-ms-10 s-img no-border 
                      ...
                      <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                  <input @if(session('admin')->id >=2) disabled="" style="background-color:#F0F0F0 !important;" @endif type="text" placeholder="Tên miền website" class="form-control thong-tin" value="{{isset($system) ? $system->domain:''  }}" required=""> 
                            </div>                       
                      </div>
                      <div class="form-group" >
