...
<?php
   $comments = App\CommentProduct::select('comment_products.*','accounts.username','products.name','products.slug')->leftJoin('accounts', 'comment_products.account_id', '=', 'accounts.id')->where('comment_products.status',1)->leftJoin('products', 'products.id', '=', 'comment_products.product_id')->orderby('created_at','desc')->paginate(10); 
?>
<div class="app-header white box-shadow">
<div class="navbar">
    <div style="float:left;" class="title_form">
       
        <p>Tất cả bình luận đã duyệt</p>
