...
@endsection
@section('content')
<form ui-jp="parsley" method="post" action="{{route('frame.create.frame.post')}}" enctype="multipart/form-data" id="form-edit-product">
<div class="app-header white box-shadow">
<div class="navbar">
		<div style="float:left;" class="title_form">
	      <p>Thêm Frame Sản Phẩm {!! $product->name !!}</p>
	    </div>
												...
												<div class="row attr-item ">
										        	...
										        	<div class="col-sm-9 d-class" style="padding-left: 12px;padding-right: 13px;">
										        		<div class="form-group attr-item ">
												            <input type="text" placeholder="Thêm {!! $attr_frame->name !!}" class="form-control " name="attrbute_frame" required >
												        </div>
										        	</div>
										        </div>
									        @endif
							...
							<div class="row">
								<div class="col-sm-12">
											<div class="form-group">
								              ...
								              <input type="text" disabled class="form-control" name="product_name" value="{{$product->name}}" autocomplete="off" >                        
								            </div>
								            <div class="form-group">
								              <label>Mã sản phẩm</label>
								              <input type="text" class="form-control" name="frame_code" autocomplete="off" value="{!! old('frame_code') !!}" >
								            </div>
								            <div class="form-group">
