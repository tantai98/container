...
<div class="navbar">
		<div style="float:left;" class="title_form">
	      <p>Sửa Frame Sản Phẩm {!! $product_id->name !!}</p>
	    </div>
			 	 ...
			 	 <div class="row masonry-container">
				          ...
				          <div class="box-body">
							<div class="row">
									<div class="col-sm-12">
												...
												<input type="hidden"  name="products" value="{!! $product_id->id !!}">
				    ...
				    <div class="col-sm-6 item">
				        <div class="box">
				          ...
				          <div class="box-body">
				          @if($attr_frame)
								<p style="font-size:10pt; color:#a6a6a6; font-family: Roboto;opacity: 0.6 ">Thuộc tính : {!! $attr_frame->name !!} là Frame mặc định của sản phẩm bắt buộc phải có </p>
				          	@endif
							<div class="row">
											...
											@if($attr_frame)
												<div class="row attr-item ">
										        		...
										        		<label style="margin-top:10px;">
														  ...
														  {!! $attr_frame->name !!}
														  <input type="hidden" name="config_frame" value="{{$attr_frame->name}}">
														</label>
										        	</div>
										        	<div class="col-sm-9 d-class" style="padding-left: 12px;padding-right: 13px;">
										        		<div class="form-group attr-item ">
												            <input type="text" placeholder="Thêm {!! $attr_frame->name !!}" class="form-control " name="attrbute_frame" required value="{!! $attr_frame1->value !!}" >
												        </div>
										        	</div>
										        </div>
									        @endif
										    ...
										    <div class="tab-pane p-v-sm @if($key==0) active @endif" id="tab_{{$key+1}}">
										     <input type="hidden" name="content[id][]" value="{{$v3->id}}">
									          ...
									          <div class="attr_container">
									          	...
									          	<input type="hidden" name="tab_list[]" class="list_attr_valie" value="{{$v_str}}">
							...
							<div class="row">
								<div class="col-sm-12">
											<div class="form-group">
								              ...
								              <input type="text" disabled class="form-control" name="product_name" value="{!! $product_id->name !!}" autocomplete="off"  >                        
								            </div>
								            <div class="form-group">
...
<!-- 								            <div class="form-group">
								            ...
								            <div class="form-group seo_tags">
										       ...
										       <input type="text" id="list_tag"  name="seo_tags"  class="form-control" autocomplete="off" value="{!!old('seo_tags'), isset($frame_tags) ? $frame_tags : ''!!}" >
									        </div>	
								            <div class="form-group">
								                <?php
