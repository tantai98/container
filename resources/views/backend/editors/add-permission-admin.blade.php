                 ...
                 <div class="box">
                  ...
                  <div class="box-body">
                        <div class="table-responsive">
                                <table class="table table-striped b-t">
                                  <tbody>
                                      <?php $a = App\Permission::where('id',24)->first(); ?>
                                        <tr>
                                      <td style="width: 5%"><label class="ui-check m-a-0"><input type="checkbox" name="post[id][]" class="has-value" value="{{$a->id}}" @if(isset($check) && in_array($a->id, $check) !==false) checked="" @endif ><i class="dark-white" ></i></label></td>
                                      <td>
                                      {{$a->name}}
                                      </td>
                                    </tr>
