...
<form ui-jp="parsley" method="post" action="<?php echo e(route('admin.post.edit')); ?>" enctype="multipart/form-data">
                ...
                <div class="box" style="padding-bottom:37px;">
                  ...
                  <div class="box-body" style="padding-bottom:2px;">
                   ...
                   <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                         <input type="email"  class="form-control thong-tin" name="email" value="<?php echo $admin->email; ?>"> 
                                    </div>                       
                              </div>
                               <div class="form-group">
                                  <label class="col-sm-2 form-control-label ">Phone</label>
                                  <div class="col-sm-10">
                                       <input type="text"  class="form-control thong-tin" name="phone" value="<?php echo e($admin->phone); ?>"> 
                                  </div>                       
                            </div>
                            <div class="form-group">
                                  <label class="col-sm-2 form-control-label ">Địa chỉ</label>
                                  <div class="col-sm-10">
                                       <input type="text" class="form-control thong-tin" name="address" value="<?php echo e($admin->address); ?>"> 
                                  </div>                       
                            </div>
                            </div>
                            </div>
                          ...
                          <div class="row">
                               ...
                               <div class="form-group" style="margin-bottom:0px">
                                   ...
                                   <label class="col-ms-10 s-img no-border" style="margin-left:11px;">
                                          <img style="margin-left:-11px;" type="hidden"<?php if(sizeof($admin)): ?> src="<?php if($admin->image): ?> <?php echo e(asset('').$admin->image); ?> <?php else: ?> https://placehold.it/100x100 <?php endif; ?>" <?php else: ?> src="https://placehold.it/100x100" <?php endif; ?>>
                               ...
                               <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                          <input type="text" disabled="" class="form-control" name="username" value="<?php echo e($admin->username); ?>"> 
                                    </div>                       
                              </div>
                              <div class="form-group" >
