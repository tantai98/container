<?php foreach($viewtt as $tuan271192): ?>
    <div class="col-xs-6 col-sm-4 col-lg-4 col-12-mobile">
        <div class="d-sp d-sp-top text-center" style="margin-top: 35px;">
            ...
            <img src="<?php echo e(asset($tuan271192->thumb_images)); ?>" alt="">
            ...
            <p><?php echo $tuan271192['name']; ?></p>
            <p class="fontBold" style="color: #000;"><?php echo $tuan271192['price']; ?>đ</p>
        </div><!-- end of d-sp -->
