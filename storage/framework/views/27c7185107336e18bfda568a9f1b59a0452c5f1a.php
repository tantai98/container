        ...
        <style type="text/css">
          ...
          <table class="table m-b-none" ui-jp="footable" data-filter="#filter" data-page-size="10">
            ...
            <tbody>
              ...
              <tr>
                  <td><?php echo e($editor->username); ?></td>
                  <td><?php echo e($editor->phone); ?></td>
            
                  <td>
                    <?php echo e($editor->address); ?>

                  </td>
                  <td class="action-post">
                    <?php if(session('admin')->can('phan_quyen_thanh_vien')): ?>
                    <a href="<?php echo e(route('editor.user.add', ['id'=>$editor->id])); ?>">
                    Phân quyền
                    </a>
                    <?php endif; ?>
                    <?php if(session('admin')->can('sua_thanh_vien')): ?>
                    <a href="<?php echo route('editor.edit',['id'=>$editor->id]); ?>" >
                    Sửa
                    </a>
                    <?php endif; ?>
                    <?php if(session('admin')->can('xoa_thanh_vien')): ?>
                    <a href="#" type="submit" id="xoa-editor" data-id="<?php echo e($editor->id); ?>">
                    Xóa
                    </a>
                    <?php endif; ?>
                  </td>
                  <td><?php echo e($editor->created_at); ?></td>
                  <td><?php echo e($editor->updated_at); ?></td>
              </tr>
              <?php endforeach; ?>
            </tbody>
          </table>
     ...
     $(document).on('click','#xoa-editor', function(event){
           ...
           if(xacnhanxoa('Bạn có chắc xóa tài khoản hiện tại hay không?')===false){
            ...
            id = $(this).attr('data-id');
             $.ajax({
                 type: 'post',
                 url:  '<?php echo e(route('del.editor')); ?>',
                 data: {'id': id},
                 dataType:'json',
