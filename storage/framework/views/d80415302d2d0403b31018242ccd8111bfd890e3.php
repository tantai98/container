...
<form ui-jp="parsley" method="post" action="<?php echo e(route('frame.edit.frame.post')); ?>" enctype="multipart/form-data" id="form-edit-product">
<div class="app-header white box-shadow">
<div class="navbar">
		<div style="float:left;" class="title_form">
	      <p>Sửa Frame Sản Phẩm <?php echo $product_id->name; ?></p>
	    </div>
				          ...
				          <div class="box-body">
							<div class="row">
									<div class="col-sm-12">
												...
												<input type="hidden"  name="products" value="<?php echo $product_id->id; ?>">
												<input type="hidden"  name="id_frame" value="<?php echo $frame->id; ?>">
									           <div class="form-group">
									              ...
									              <p style="margin-bottom:10px;line-height:0px">
									               <img id="img_preview" style="max-height:200px;" <?php if($frame->img): ?> src="<?php echo e($frame->thumb_images); ?>" <?php endif; ?> >
									              </p>
							  ...
							  <div class="modal-dialog" id="animate">
							    <div class="modal-content">
							      ...
							      <div class="modal-body p-lg">
										...
										<?php $frame_config = App\Item::where('key_item','config_frame_attribute')->first(); ?>

							      		<?php $attribute = App\Attribute::where('type',1)->groupby('name')->orderby('created_at')->get();
							      			if($frame_config){
											$attr_frame = App\Attribute::where('id',$frame_config->value)->first();
										}
										?>
												...
												<div class="row attr-item ">
										        	...
										        	<div class="col-sm-9 d-class" style="padding-left: 12px;padding-right: 13px;">
										        		<div class="form-group attr-item ">
												            <input type="text" placeholder="Thêm <?php echo $attr_frame->name; ?>" class="form-control " name="attrbute_frame" required value="<?php echo $attr_frame1->value; ?>" >
												        </div>
										        	</div>
										        </div>
									        <?php endif; ?>
							...
							<div class="row">
									<div class="col-sm-12" style="">
									        ...
									        <select id="single" class="form-control select2" name="label">
									            <option value="0" <?php if($frame->label == 0): ?> selected  <?php endif; ?>>Không nhãn</option>
									            <option value="1" <?php if($frame->label == 1): ?> selected  <?php endif; ?>>New</option>
									            <option value="2" <?php if($frame->label == 2): ?> selected  <?php endif; ?>>Kool</option>
									            <option value="3" <?php if($frame->label == 3): ?> selected  <?php endif; ?>>Sale</option>
									        </select>
									    </div>	
									</div>
				         	</div>	 
							...
							<div class="row">
								<div class="col-sm-12">
											<div class="form-group">
								              ...
								              <input type="text" disabled class="form-control" name="product_name" value="<?php echo $product_id->name; ?>" autocomplete="off"  >                        
								            </div>
								            <div class="form-group">
								              <label>Mã sản phẩm</label>
								              <input type="text" class="form-control" name="code_frame"  value="<?php echo e($frame->code_frame); ?>" autocomplete="off" >
								            </div>
								            <div class="form-group">
								              <label>Mô tả ngắn</label>
								              <textarea name="frame_des" class="form-control" rows="5"><?php echo $frame->description; ?></textarea>
								            </div>
										    <div class="form-group m-money">
								              <label>Giá niêm yết</label>
								              <input  type="text" class="form-control" name="price" value="<?php echo e($frame->price); ?>" autocomplete="off" >
								              <div class="m-tooltip"></div>
								            </div>
								             <div class="form-group m-money">
								              <label>Giá bán</label>
								              <input  type="text" class="form-control" name="price_sale" value="<?php echo e($frame->price_sale); ?>"  autocomplete="off" >
								              <div class="m-tooltip"></div>
								            </div>
<!-- 								            <div class="form-group">
								            ...
								            <div class="form-group seo_tags">
										       ...
										       <input type="text" id="list_tag"  name="seo_tags"  class="form-control" autocomplete="off" value="<?php echo old('seo_tags'), isset($frame_tags) ? $frame_tags : ''; ?>" >
									        </div>	
								            <div class="form-group">
								                <?php
  ...
  <script>
	...
	$(function() {
	    ...
	    $("div#myDropZone").dropzone({
	    		maxFiles:6 - <?php echo e($images->count()); ?>,
	            ...
	            addRemoveLinks : true,
			    maxFilesize: 5 - <?php echo e($images->count()); ?>,
			    dictDefaultMessage: '',
		...
		<?php foreach($images as $img): ?>
			  ...
			  var myFile = {
				    name: "<?php echo $img->img; ?>",
				    <?php if(file_exists(public_path().''.$img->img)): ?>
				    	size: "<?php echo filesize(public_path().''.$img->img); ?>"
				    <?php endif; ?>
			  };
			  myDropzone.emit("addedfile", myFile);
		      myDropzone.createThumbnailFromUrl(myFile, '<?php echo e(asset($img->img)); ?>');
