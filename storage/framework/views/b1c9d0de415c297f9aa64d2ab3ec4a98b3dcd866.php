              ...
              <ol class="dd-list dd-list-handle">
                   ...
                   <li class="dd-item" data-id="<?php echo e($v0->id); ?>">
                    <div class="dd-content box">
                      ...
                      <div>
                          <div class="menu_name"><?php echo e($v0->name); ?></div>
                          <?php if(session('admin')->can('sua_menu')): ?>
                          <div class="change_pos menu_edit noselect">
                           ...
                           <?php endif; ?>
                           <?php if(session('admin')->can('xoa_menu')): ?>
                          <div class="menu_edit">
                            <a href="#" class="" type="submit" id="xoa-menu" data-id="<?php echo e($v0->id); ?>">
                                Xóa
                            </a>
                          </div>
                          <?php endif; ?>
                           <?php if(session('admin')->can('sua_menu')): ?>
                          <div class="menu_edit">
                            <a href="<?php echo e(route('menu.edit',['id'=>$v0->id])); ?>">
                              Sửa
                            </a>
                          </div>
                          <?php endif; ?>
                          ...
                          foreach ($d as $v) {
                             ?>
                              <li class="dd-item" data-id="<?php echo e($v->id); ?>">
                                  <div class="dd-content box">
                                    <div>
                                        <div class="menu_name"><?php echo e($v->name); ?></div>
                                        <?php if(session('admin')->can('sua_menu')): ?>
                                        <div class="change_pos menu_edit noselect">
                                          <div class="up">
                                            <i class="material-icons md-24">&#xe5c7;</i>
                                        ...
                                        <?php if(session('admin')->can('xoa_menu')): ?>
                                        <div class="menu_edit">
                                          <a href="#" type="submit" id="xoa-menu" data-id="<?php echo e($v->id); ?>">
                                            Xóa
                                          </a>
                                        </div>
                                        <?php endif; ?>
                                         <?php if(session('admin')->can('sua_menu')): ?>
                                        <div class="menu_edit">
                                          <a href="<?php echo e(route('menu.edit',['id'=>$v->id])); ?>">
                                            Sửa
                                          </a>
                                        </div>
                                        <?php endif; ?>
     ...
     $(document).on('click','#xoa-menu', function(event){
           ...
           if(xacnhanxoa('Bạn có chắc xóa menu hiện tại hay không?')===false){
            ...
            id = $(this).attr('data-id');
             $.ajax({
                 type: 'post',
                 url:  '<?php echo e(route('menu.del')); ?>',
                 data: {'id': id},
                 dataType:'json',
                 success: function(msg){
                   console.log(msg);
                    if(msg == true){
                      window.location= '<?php echo e(route('menu.list')); ?>';
                    }
                    else{
                      alert('có lỗi xảy ra');
                    }
