...
<form ui-jp="parsley" method="post" action="<?php echo e(route('product.edit')); ?>" enctype="multipart/form-data" id="form-edit-product">
									...
									<div class="col-sm-12">
									           ...
									           <div class="form-group">
									              ...
									              <p style="margin-bottom:10px;line-height:0px">
									               <img id="img_preview" style="max-height:200px;" <?php if($product->img): ?> src="<?php echo e($product->img); ?>" <?php endif; ?>>
									              </p>
							...
							<div class="row">
									<div class="col-sm-12" id="atrribute-containner">
												...
												<div class="row attr-item ">
										        	...
										        	<div class="col-sm-9 d-class" style="padding-left: 12px;padding-right: 13px;">
										        		<div class="form-group attr-item ">
												            <input type="text" placeholder="Thêm Màu Sắc" class="form-control " name="attrbute_frame" required value="<?php echo $frame_attr->value; ?>">
												        </div>
										        	</div>
										        </div>
									        <?php endif; ?>
											<?php foreach($attr as $key => $value ): ?>
									      	<div class="row attr-item ">
									        	<div class="col-sm-3">
									        		<label style="margin-top:10px;"><?php echo e($value->name); ?></label>
									        	</div>
									        	<div class="col-sm-9">
									        		<div class="form-group attr-item ">
									        			<input type="hidden"  name="attrbute_k[]" value="<?php echo e($value->name); ?>">
											            <input type="text" class="form-control i_name" name="attrbute_v[]" value="<?php echo e($value->value); ?>">
											        </div>
									        	</div>
									        </div>
									        <?php endforeach; ?>
							...
							<div class="row">
									<div class="col-sm-12" style="">
									        ...
									        <select id="single" class="form-control select2" name="label">
									            <option value="0" <?php if($product->label == 0 ): ?> selected <?php endif; ?>>Không nhãn</option>
									            <option value="1" <?php if($product->label == 1 ): ?> selected <?php endif; ?>>New</option>
									            <option value="2" <?php if($product->label == 2 ): ?> selected <?php endif; ?>>Kool</option>
									            <option value="3" <?php if($product->label == 3 ): ?> selected <?php endif; ?>>Sale</option>
									        </select>
									    </div>	
									</div>
				         	</div>	 
							...
							<div class="row">
								<div class="col-sm-12">
											<div class="form-group">
								              ...
								              <input type="text" class="form-control" name="product_name" value="<?php echo e($product->name); ?>" autocomplete="off" >                        
								            </div>
								            <div class="form-group">
								              <label>Mã sản phẩm</label>
								              <input type="text" class="form-control" name="product_code" value="<?php echo e($product->code_product); ?>" autocomplete="off" >
								            </div>
								            <div class="form-group">
								              <label>Mô tả ngắn</label>
								              <textarea name="product_des" class="form-control" rows="5"><?php echo e($product->short_description); ?></textarea>
								            </div>
										    <div class="form-group m-money">
								              <label>Giá niêm yết</label>
								              <input  type="text" class="form-control" name="price"  value="<?php echo e($product->price); ?>" autocomplete="off" >
								              <div class="m-tooltip"></div>
								            </div>
								             <div class="form-group m-money">
								              <label>Giá bán</label>
								              <input  type="text" class="form-control" name="price_sale" value="<?php echo e($product->price_sale); ?>"  autocomplete="off" >
								              <div class="m-tooltip"></div>
								            </div>
<!-- 								            <div class="form-group">
								            ...
								            <div class="form-group seo_tags">
										       ...
										       <input type="text" id="list_tag"  name="seo_tags"  class="form-control" autocomplete="off" value="<?php echo old('seo_tags'), isset($product_tags) ? $product_tags : ''; ?>">
									        </div>	
								            <div class="form-group">
								                <?php
