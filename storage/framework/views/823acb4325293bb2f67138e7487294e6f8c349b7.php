...
<form ui-jp="parsley" method="post" action="<?php echo e(route('admin.system.post.edit')); ?>" enctype="multipart/form-data">
              ...
              <input type="hidden" value="<?php echo e(csrf_token()); ?>" name="_token">
               ...
               <div class="form-group">
                     ...
                     <label class="col-ms-10 s-img no-border 
                      " >
                      <img  type="hidden" <?php if(sizeof($system)): ?> src="<?php if($system->img_logo): ?> <?php echo e(asset('').$system->img_logo); ?> <?php else: ?> https://placehold.it/130x40 <?php endif; ?>" <?php else: ?> 
                       src="https://placehold.it/130x40"   <?php endif; ?>
                      >
                      ...
                      <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                  <input <?php if(session('admin')->id >=2): ?> disabled="" style="background-color:#F0F0F0 !important;" <?php endif; ?> type="text" placeholder="Tên miền website" class="form-control thong-tin" value="<?php echo e(isset($system) ? $system->domain:''); ?>" required=""> 
                            </div>                       
                      </div>
                      <div class="form-group" >
                      ...
                      <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                 <input type="email"   placeholder="Email" class="form-control thong-tin" name="s_email" value="<?php echo e(isset($system) ? $system->email:''); ?>"> 
                            </div>                       
                      </div>
                      <div class="form-group">
                            <label class="col-sm-2 form-control-label ">Phone</label>
                            <div class="col-sm-10">
                                 <input type="text"  placeholder="Số điện thoại" class="form-control thong-tin" name="s_phone" value="<?php echo e(isset($system) ? $system->phone:''); ?>"> 
                            </div>                       
                      </div>
                      <div class="form-group">
                            <label class="col-sm-2 form-control-label ">Địa chỉ</label>
                            <div class="col-sm-10">
                                 <input type="text" class="form-control thong-tin"  placeholder="Địa chỉ" name="s_address" value="<?php echo e(isset($system) ? $system->address:''); ?>"> 
                            </div>                       
                      </div>  
                    </div>
                  </div>
              ...
              <div class="box-body" style="padding:0 16px;" >
                ...
                <div style="padding:0px;border-bottom:1px solid #F0F0F0;">
                  ...
                  <div class="form-group">
                        <label class="col-sm-2 form-control-label ">Email</label>
                        <div class="col-sm-10">
                             <input type="email" style="background-color:#F0F0F0 !important;"  placeholder="Email Send" class="form-control thong-tin" name="email_send" value="<?php echo e(isset($system) ? $system->email_send:''); ?>" autocomplete="off"> 
                        </div>                       
                  </div>
                   <div class="form-group" >
                          <label class="col-sm-2 form-control-label">Password</label>
                          <div class="col-sm-10">
                               <input type="password"  style="background-color:#F0F0F0 !important;" placeholder="MK Email Send"  class="form-control thong-tin" name="EMpassword" value="<?php echo e(isset($system) ? $system->email_password:''); ?>"   autocomplete="off" > 
                          </div>                       
                    </div>
                </div>
                </div>
              ...
              <div class="box-body" style="padding:0px 16px 0px 16px">
                <div class="row">
                   <div class="form-group">
                        ...
                        <div class="col-sm-10">
                             <input type="email"   placeholder="Email Nhận" class="form-control thong-tin" name="email_form" value="<?php echo e(isset($system) ? $system->email_form:''); ?>"> 
                        </div>                       
                  </div>
                  <div class="form-group">
                        <label class="col-sm-2 form-control-label ">Đơn Hàng</label>
                        <div class="col-sm-10">
                             <input type="email"   placeholder="Email Đơn Hàng" class="form-control thong-tin" name="email_order" value="<?php echo e(isset($system) ? $system->email_order:''); ?>"> 
                        </div>                       
                  </div>
                </div>
              </div>
