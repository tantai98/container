...
<form ui-jp="parsley" method="post" action="<?php echo e(route('ppostt_posts.add')); ?>" enctype="multipart/form-data" id="add_post_form">
...
<?php $__env->startSection('js-footer'); ?>
  ...
  <script src="<?php echo e(asset('libs/bootstrap-tagsinput/bootstrap-tagsinput.js')); ?>"></script>
	...
	$(document).on('click','.autocomplete_tag',function(e){
  	...
  	$(document).on('keyup','.seo_tags .bootstrap-tagsinput input',function(e){
  		...
  		if($(cony).hasClass('data_avaiable')){
              ...
              type:"post",
              url:"<?php echo e(route('get_list_tag_ajax')); ?>",
