...
<form ui-jp="parsley" method="post" action="<?php echo e(route('product.add')); ?>" enctype="multipart/form-data" id="form-add-product">
								...
								<div class="col-sm-12">
								            ...
								            <div class="form-group">
											        ...
											        <select id="multiple" class="form-control select2-multiple" name="choose_cate[]" multiple >
											        	<?php echo e(cate_parent($list_categories)); ?>
