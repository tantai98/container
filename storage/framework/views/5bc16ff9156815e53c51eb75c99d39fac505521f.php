      ...
      <div class="box">
        ...
        <div class="box-body">
          ...
          <div class="dropdown-menu pull-right">
              <a  class="dropdown-item" href="<?php echo e(route('tags.product.list')); ?>">Tất cả</a>
            <?php foreach($list_categories as $v0): ?>
              <a  class="dropdown-item" href="<?php echo e(route('product.tags.detail.cate',['id'=>$v0->id])); ?>"><?php echo e($v0->name); ?></a>
              <?php if($v0->subcategory): ?>
                   <?php foreach($v0->subcategory as $v1): ?>
                        <a  class="dropdown-item"  href="<?php echo e(route('product.tags.detail.cate',['id'=>$v1->id])); ?>"><?php echo e($space); ?><?php echo e($v1->name); ?></a>
                        <?php if($v1->subcategory): ?>
                          <?php foreach($v1->subcategory as $v2): ?>
                            <a  class="dropdown-item"  href="<?php echo e(route('product.tags.detail.cate',['id'=>$v2->id])); ?>"><?php echo e($space.$space); ?><?php echo e($v2->name); ?></a>
                                <?php if($v2->subcategory): ?>
                                <?php foreach($v2->subcategory as $v3): ?>
                                  <a  class="dropdown-item" href="<?php echo e(route('product.tags.detail.cate',['id'=>$v3->id])); ?>"><?php echo e($space.$space.$space); ?><?php echo e($v3->name); ?></a>
                                  <?php if($v3->subcategory): ?>
                                     <?php foreach($v3->subcategory as $v4): ?>
                                      <a  class="dropdown-item" href="<?php echo e(route('product.tags.detail.cate',['id'=>$v4->id])); ?>"><?php echo e($space.$space.$space.$space); ?><?php echo e($v4->name); ?></a>
                                     <?php endforeach; ?>
                                 <?php endif; ?>
                                 <?php endforeach; ?>
                             <?php endif; ?>
              ...
              <tr>
                 ...
                 <!--  <td>
                  ...
                  <td class="action-post">
                    ...
                    <a class="edit" href="#" type="button" data-id="<?php echo $item->id; ?>">
                    Sửa
                    </a>
                    <a href="#" type="submit" id="xoa-tag" data-id="<?php echo $item->id; ?>">
                    Xóa
                    </a>
                  </td>
...
<?php $__env->startSection('js-footer'); ?>
  ...
  function xacnhanxoa(msg){
   ...
   $(document).on('click', '.edit', function(event){
    ...
    $.ajax({
      type: 'get',
      url:  '<?php echo e(route('tags.product.edit', 'id')); ?>',
      data: { 'id' : id},
   ...
   $(document).on('click','#xoa-tag', function(event){
           ...
           if(xacnhanxoa('Bạn có chắc xóa tag hiện tại hay không?')===false){
            ...
            id = $(this).attr('data-id');
             $.ajax({
                 type: 'post',
                 url:  '<?php echo e(route('tags.product.del')); ?>',
