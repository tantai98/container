                       ...
                       <!--  <div class="dd-handle">
                        ...
                        <div>
                            <div class="cate_name"><?php echo e($v0->name); ?></div>
                              ...
                              <?php if(session('admin')->can('xoa_danh_muc_san_pham')): ?>
                                 <div class="cate_edit">
                              ...
                              <?php endif; ?>  
                              <?php endif; ?>
                              <?php if(session('admin')->can('sua_danh_muc_san_pham')): ?> 
                                <div class="cate_edit">
                                <a href="<?php echo e(route('cate.products.edit',['id'=>$v0->id])); ?>">
                                  Sửa
                                </a>
                                </div>
                              <?php endif; ?>
                            <div class="cate_edit">
                                <a href="<?php echo e(route('cate.products.detail',['id'=>$v0->id])); ?>">
                                  Xem
                                </a>
                            </div>
                        </div>
                                ...
                                <li class="dd-item" data-id="<?php echo e($v->id); ?>">
                                    <div class="dd-content box">
                                      ...
                                      <div>
                                          ...
                                          <div class="cate_edit">
                                            <a href="<?php echo e(route('cate.products.edit',['id'=>$v->id])); ?>">
                                              Sửa
                                            </a>
                                          </div>
                                          <?php endif; ?>
                                          <div class="cate_edit">
                                            <a href="<?php echo e(route('cate.products.detail',['id'=>$v->id])); ?>">
                                              Xem
                                            </a>
                                          </div>
                                      </div>
     ...
     $(document).on('click','#xoa-cate', function(event){
           ...
           if(xacnhanxoa('Bạn có chắc xóa danh mục hiện tại hay không?')===false){
            ...
            id = $(this).attr('data-id');
             $.ajax({
                 type: 'post',
                 url:  '<?php echo e(route('cate.products.del')); ?>',
                 data: {'id': id},
                 dataType:'json',
                 success: function(msg){
                   console.log(msg);
                    if(msg == true){
                      window.location= '<?php echo e(route('dev.list.category.product')); ?>';
                    }
                    else{
                      alert('có lỗi xảy ra');
                    }
