        ...
        <?php $__env->startSection('css'); ?>
            <link rel="stylesheet" href="<?php echo e(asset('frontend/html/css/d-catagory.css')); ?>">
                ...
                <div class="button-offcanvas">
                    <p class="pull-left visible-xs visible-sm">
                        <button type="button" class="btn btn-primary btn-xs btn-offcanvas" data-toggle="offcanvas">
                            <img src="<?php echo e(asset('frontend/html/images/filter.svg')); ?>" alt="">
                        </button>
                    </p>
                        ...
                        <div class="col-xs-6 col-sm-4 col-lg-4 col-12-mobile">
                            <div class="d-sp d-sp-top text-center" style="margin-top: 35px;">
                                ...
                                <p class="fontBold" style="color: #000;">
                                    ...
                                    <?php if($data->price_sale): ?>
                                        <?php echo e($data->price_sale); ?>
        ...
        <div class="tan_page">
            <ul>
                ...
                ?>
                <ul>
                  <li><a href="<?php echo e($products->url(1)); ?>">Trước</a></li>
                  <?php for($i = 1; $i <= $products->lastPage(); $i++): ?>
                            ...
                            ?>
                            <?php if($from < $i && $i < $to): ?>
                                <li class=" <?php echo e(($products->currentPage() == $i) ? 't-page' : ''); ?>">
                                    <a href="<?php echo e($products->url($i)); ?>"><?php echo e($i); ?></a>
                                </li>
                            <?php endif; ?>
                  <?php endfor; ?>
                  <li class="next"><a href="<?php echo e($products->url($products->lastPage())); ?>">Sau</i></a></li>
                </ul>
                <!-- /.list-inline --> 
              </div>
            </ul>
          ...
          <script type="text/javascript">
                $(document).on('click','.optradio1',function(e){
                    ...
                    $.ajax({
                        ...
                        type:"post",
                        url:"<?php echo e(route('view.category.filter1')); ?>",
                        data:{'psaph':a},
