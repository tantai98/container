...
<div class="navbar">
    <form ui-jp="parsley" action="<?php echo e(route('layout.group.post_add')); ?>" method="post">
      <div style="float:left;" class="title_form">
          <input style="font-family: 'Roboto Black';font-size: 14pt; " type="" name="" placeholder="Nhập tên Nhóm layout" value="<?php echo e($layout_group->name); ?>" disabled>
      </div>
    ...
    <div class="padding">
      <div class="row masonry-container">
                ...
                <div class="col-sm-6 col-md-4 item">
                 <form class="" id="form" method="post" action="<?php echo e(route('dev.add.item')); ?>" enctype="multipart/form-data">
                      <div class="box">
                          ...
                          <div class="box-body">
                                  ...
                                  <ul class="list no-border p-b">
                                        ...
                                        <input type="hidden" name=" contribute_id" value="<?php echo e($layout_group->id); ?>">
                                        <li class="list-item">
                                          <div class="s-name">
                 ...
                 <!-- for -->
                <?php foreach($layout as $i_l): ?>
                <div class="col-sm-6 col-md-4 item">
                 <form class="" id="form" method="post" action="<?php echo e(route('dev.add.item')); ?>" enctype="multipart/form-data">
                      <div class="box">
                          <div class="box-header">
                            <h3>
                              <input type="" name="layout_name" value="<?php echo e($i_l->name); ?>">
                            </h3>
                          </div>
                           <div class="box-body">
                              <ul class="list no-border p-b">
                              ...
                              <?php foreach($l_item as $i_i): ?>
                                  <?php if($i_i->type =="des"): ?>
                                    <li class="list-item item-editable">
                                      <span><?php echo e($i_i->key_item); ?>

                                         <span data-v="<?php echo e($i_i->id); ?>">×</span>
                                      </span>
                                      <input style="display:none" name="text_name[]" value="<?php echo e($i_i->key_item); ?>">
                                      <input style="display:none" name="text_id[]" value="<?php echo e($i_i->id); ?>">
                                      <textarea class="form-control" rows="3" name="text_value[]"><?php echo e($i_i->value); ?></textarea>
                                      <?php if($i_i->pin): ?>
                                  ...
                                  <?php else: ?>
                                    <li class="list-item item-editable">
                                      ...
                                      <input style="display:none" name="img_name[]" value="<?php echo e($i_i->key_item); ?>">
                                      <input style="display:none" name="img_id[]" value="<?php echo e($i_i->id); ?>">
                                      <div class="s-img-container">
                                        <label class="s-img   <?php if($i_i->value): ?> s-img-reset  <?php endif; ?>">
                                          <img <?php if($i_i->value): ?> src="<?php echo e(asset($i_i->value)); ?>" <?php endif; ?>>
